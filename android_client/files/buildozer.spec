...
# (str) Package name
package.name = linkedalert

# (str) Package domain (needed for android/ios packaging)
package.domain = org.linkedalert
...
requirements = python3,kivy==2.2.1,kivymd==1.1.1,socket,threading,json,android,pyjnius,cython
...
# (list) Permissions
android.permissions = INTERNET, VIBRATE, FLASHLIGHT, RECORD_AUDIO, READ_EXTERNAL_STORAGE, WRITE_EXTERNAL_STORAGE, SYSTEM_ALERT_WINDOW, WAKE_LOCK, FOREGROUND_SERVICE
